 ...
 */
function clight_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['clight_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('clight sample setting'),
  '#default_value' => theme_get_setting('clight_example'),
